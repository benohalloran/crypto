...
import io.ohalloran.crypto.dummy.DummyContent;
...
public class ConversationListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ListAdapter<Person> adapter = new Adapter2<Person>(getActivity(), ParseFactory.getPeople(),
                android.R.layout.simple_list_item_activated_1, android.R.id.text1);
        setListAdapter(adapter);
        ParseFactory.refresh(new ParseFactory.OnParseUpdateListener() {
            @Override
